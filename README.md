# CCNA-Core-Projects
“Multi-Branch Enterprise Network Design and Implementation using Cisco Packet Tracer"

Description :
This project demonstrates the design and configuration of a multi-branch enterprise network using Cisco Packet Tracer. The topology consists of a core router connected to four branch routers through serial links configured with the PPP protocol. Each branch contains a LAN network connected through switches and hosts.
